const displayCourseWarningComponent = () => {
  ...
  newNode.innerHTML =
    '<p class="alert alert-success"> Bọn mình là <b>TIT EXTENSION</b>, tiện ích này sẽ giúp 4-5 năm học Đại học của bạn dễ dàng hơn </p>';
...
const gettPermissionNotification = async () => {
  ...
  if (!clientPermission) {
    ...
    localStorage.setItem("isCanNoti", newPermission ?? +clientPermission);
  }
};
